...
| 版本 | 日期 | 主要变更 |
|---|---|---|
| **v20.18.0** | 2026-06-16 | **实战 59：商业化前 4 件**（privacy.html 7KB + terms.html 7KB + pricing.html 10KB + 支付 6 端点 /v1/pay/{create,query,cancel,callback,orders,mock_pay} + 沙箱模式 + tier 升级端到端跑通）|
